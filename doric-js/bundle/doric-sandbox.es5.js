var doric = (function (exports) {
    ...
    ***************************************************************************** */
                            ...
                            get: function (target, p) {
                                if (Reflect.has(target, p)) {
                                    ...
                                    return function () {
                                        ...
                                        return Reflect.apply(context_1.callNative, context_1, args);
                                    };
                                }
                            }
                        });
    ...
    function jsObtainContext(id) {
        if (gContexts.has(id)) {
            var context_2 = gContexts.get(id);
            setContext(context_2);
            return context_2;
        }
        else {
            var context_3 = new Context(id);
            gContexts.set(id, context_3);
    ...
    var _clearTimeout = global$1.clearTimeout;
    var _clearInterval = global$1.clearInterval;

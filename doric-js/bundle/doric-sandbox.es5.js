	...
	*/
	...
	var createIteratorProxyPrototype = function (IS_ITERATOR) {
	  ...
	  var IteratorProxyPrototype = defineBuiltIns(objectCreate(IteratorPrototype$1), {
	    ...
	    'return': function () {
	      ...
	      if (IS_ITERATOR) {
	        var returnMethod = getMethod(iterator, 'return');
	        return returnMethod ? functionCall(returnMethod, iterator) : { value: undefined, done: true };
	      }
	      var innerIterator = state.innerIterator;
	      if (innerIterator) { try {
	        iteratorClose(innerIterator, 'return');
	...
	var $DOMException$1 = function DOMException() {
	  ...
	  if (HAS_STACK) {
	    ...
	    defineProperty$1(this, 'stack', createPropertyDescriptor(1, errorStackClear(error.stack, 1)));
	  }
	};

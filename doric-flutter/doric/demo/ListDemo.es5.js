...
function rotatedArrow() {
    ...
    return doric.pullable(doric.stack([
        ...
        }).also(function (v) { return refreshImage = v; }) ]), {
...
var ListPanel = /*@__PURE__*/(function (Panel) {
    function ListPanel () {
        Panel.apply(this, arguments);
    }

    if ( Panel ) ListPanel.__proto__ = Panel;
    ListPanel.prototype = Object.create( Panel && Panel.prototype );
    ListPanel.prototype.constructor = ListPanel;

    ListPanel.prototype.build = function build (rootView) {
        var refreshView;
        var offset = Math.ceil(Math.random() * colors.length);
        doric.vlayout([
            doric.text({
                text: "ListDemo",
                layoutConfig: {
            ...
            refreshView = doric.refreshable({
                onRefresh: function () {
                    refreshView.setRefreshing(context, false).then(function () {
                        refreshView.content.also(function (it) {
                            it.reset();
                            offset = Math.ceil(Math.random() * colors.length);
                            it.itemCount = 40;
                            it.loadMore = true;
                            it.onLoadMore = function () {
                                setTimeout(function () {
                                    it.itemCount += 10;
                                }, 1000);
                            };
                            ...
                            it.renderItem = function (idx) {
                                ...
                                return doric.listItem(doric.hlayout([
                                    ...
                                    it.onClick = function () {
                                        ...
                                        it.height += 10;
                                        it.nativeChannel(context, "getWidth")().then(function (resolve) {
                ...
                content: doric.list({
                    itemCount: 0,
                    renderItem: function () { return new doric.ListItem; },
                    layoutConfig: {
                        widthSpec: doric.LayoutSpec.MOST,
        ...
        refreshView.backgroundColor = doric.Color.YELLOW;
    };
...
//# sourceMappingURL=ListDemo.es5.js.map

import { Group, text, HorizontalList, gravity, Color, LayoutSpec, vlayout, layoutConfig, ViewHolder, ViewModel, VMPanel, loge, stack, horizontalList, horizontalListItem } from "doric";
...
export class HorizontalListPanel extends VMPanel<ListModel, ListVH> {
  getViewModelClass() {
    return ListVM
  }
  getViewHolderClass() {

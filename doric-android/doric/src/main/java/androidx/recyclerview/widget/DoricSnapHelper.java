 ...
 */
public abstract class DoricSnapHelper extends RecyclerView.OnFlingListener {
    ...
    private boolean scrollTriggeredManually = false;

    public void setScrollTriggeredManually() {
        this.scrollTriggeredManually = true;
    }
}

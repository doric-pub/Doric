 ...
 * {@link LayoutParams DoricLinearLayoutCompat.LayoutParams}.
...
public class DoricLinearLayoutCompat extends ViewGroup {
    /**
     * @hide
     */
    ...
    public DoricLinearLayoutCompat(@NonNull Context context) {
        this(context, null);
    }

    public DoricLinearLayoutCompat(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DoricLinearLayoutCompat(

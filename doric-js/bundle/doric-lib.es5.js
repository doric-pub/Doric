    ...
    function View() {
        ...
        return new Proxy(this, {
            ...
            set: function (target, p, v, receiver) {
                var oldV = Reflect.get(target, p, receiver);
                var ret = Reflect.set(target, p, v, receiver);
...
var Group = /** @class */ (function (_super) {
    ...
    function Group() {
        ...
        _this.children = new Proxy([], {
            set: function (target, index, value) {
                var ret = Reflect.set(target, index, value);
                // Let getDirty return true
                _this.dirtyProps.children = _this.children.map(function (e) { return e.viewId; });
                return ret;
            }
        });
        return _this;

...
public class NewHVScrollView extends ViewGroup implements NestedScrollingParent,
...
//    private boolean mIsBeingDragged;
    ...
    public interface OnScrollChangeListener {
         ...
         */
        void onScrollChange(NewHVScrollView v, int scrollX, int scrollY,
...
//    private boolean mIsBeingDragged = false;
    ...
    public NewHVScrollView(Context context) {
        this(context, null);
    }

    public NewHVScrollView(Context context, AttributeSet attrs) {
    ...
    public NewHVScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initScrollView();

        mChildLayoutCenter = false;
        mFillViewportH = true;
        mFillViewportV = false;
        mScrollOrientation = SCROLL_ORIENTATION_BOTH;
...
//                canvas.rotate(90, 0, 0);
    ...
    static class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public boolean performAccessibilityAction(View host, int action, Bundle arguments) {
            ...
            final NewHVScrollView nsvHost = (NewHVScrollView) host;

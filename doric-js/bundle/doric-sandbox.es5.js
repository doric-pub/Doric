var doric = (function (exports) {
	...
	var classofRaw = function (it) {
	  return stringSlice$l(toString$2(it), 8, -1);
	};
	...
	var requireObjectCoercible = function (it) {
	  if (isNullOrUndefined(it)) { throw new $TypeError$P("Can't call method on " + it); }
	  return it;
	};
	...
	var aCallable = function (argument) {
	  ...
	  throw new $TypeError$O(tryToString(argument) + ' is not a function');
	};
	...
	var defineGlobalProperty = function (key, value) {
	  try {
	    defineProperty$f(globalThis_1, key, { value: value, configurable: true, writable: true });
	  } catch (error) {
	...
	var anObject = function (argument) {
	  ...
	  throw new $TypeError$L($String$7(argument) + ' is not an object');
	};
	...
	var WeakMap$4 = globalThis_1.WeakMap;
	...
	var WeakMap$3 = globalThis_1.WeakMap;
	...
	var getterFor$2 = function (TYPE) {
	  return function (it) {
	    var state;
	    if (!isObject(it) || (state = get$a(it)).type !== TYPE) {
	...
	var push$x = functionUncurryThis([].push);
	...
	var objectKeysInternal = function (object, names) {
	  ...
	  var result = [];
	  var key;
	  for (key in O) { !hasOwnProperty_1(hiddenKeys$1, key) && hasOwnProperty_1(O, key) && push$x(result, key); }
	...
	*/
	...
	var arraySpeciesConstructor = function (originalArray) {
	  ...
	  if (isArray$1(originalArray)) {
	    ...
	    if (isConstructor(C) && (C === $Array$d || isArray$1(C.prototype))) { C = undefined; }
	    else if (isObject(C)) {
	      C = C[SPECIES$6];
	...
	var push$w = functionUncurryThis([].push);
	...
	var push$v = functionUncurryThis([].push);
	...
	var $getOwnPropertyNames = function getOwnPropertyNames(O) {
	  ...
	  $forEach$3(names, function (key) {
	    if (!hasOwnProperty_1(AllSymbols, key) && !hasOwnProperty_1(hiddenKeys$1, key)) { push$v(result, key); }
	  });
	  return result;
	};
	...
	var push$u = functionUncurryThis([].push);
	...
	var getJsonReplacerFunction = function (replacer) {
	  ...
	  for (var i = 0; i < rawLength; i++) {
	    ...
	    else if (typeof element == 'number' || classofRaw(element) === 'Number' || classofRaw(element) === 'String') { push$u(keys, toString_1(element)); }
	  }
	...
	var numberToString$5 = functionUncurryThis(1.1.toString);
	...
	var FORCED$L = !symbolConstructorDetection || fails(function () { objectGetOwnPropertySymbols.f(1); });

	// `Object.getOwnPropertySymbols` method
	// https://tc39.es/ecma262/#sec-object.getownpropertysymbols
	_export({ target: 'Object', stat: true, forced: FORCED$L }, {
	...
	if (descriptors && isCallable(NativeSymbol) && (!('description' in SymbolPrototype) ||
	  ...
	  defineBuiltInAccessor(SymbolPrototype, 'description', {
	    ...
	    get: function description() {
	      ...
	      var desc = NATIVE_SYMBOL ? stringSlice$k(string, 7, -1) : replace$a(string, regexp, '$1');
	...
	if (Symbol$6) {
	  ...
	  if (descriptor$4.enumerable && descriptor$4.configurable && descriptor$4.writable) {
	    defineProperty$c(Symbol$6, 'asyncDispose', { value: descriptor$4.value, enumerable: false, configurable: false, writable: false });
	  }
	}
	...
	if (Symbol$5) {
	  ...
	  if (descriptor$3.enumerable && descriptor$3.configurable && descriptor$3.writable) {
	    defineProperty$b(Symbol$5, 'dispose', { value: descriptor$3.value, enumerable: false, configurable: false, writable: false });
	  }
	}
	...
	var exportGlobalErrorCauseWrapper = function (ERROR_NAME, wrapper) {
	  ...
	  _export({ global: true, constructor: true, arity: 1, forced: FORCED$K }, O);
	};
	...
	var exportWebAssemblyErrorCauseWrapper = function (ERROR_NAME, wrapper) {
	  if (WebAssembly && WebAssembly[ERROR_NAME]) {
	    ...
	    _export({ target: WEB_ASSEMBLY, stat: true, constructor: true, arity: 1, forced: FORCED$K }, O);
	  }
	};
	...
	var FORCED$J = !$isError || !PROTOTYPE_SETTING_AVAILABLE || fails(function () {
	  ...
	  return (DOMException$1 && !$isError(new DOMException$1(DOM_EXCEPTION$3))) ||
	    ...
	    $isError(getBuiltIn('Object', 'create')($Error$2.prototype));
	});

	// `Error.isError` method
	// https://tc39.es/ecma262/#sec-error.iserror
	_export({ target: 'Error', stat: true, sham: true, forced: FORCED$J }, {
	...
	var getIterator = function (argument, usingIterator) {
	  ...
	  throw new $TypeError$I(tryToString(argument) + ' is not iterable');
	};
	...
	var $AggregateError$1 = function AggregateError(errors, message /* , options */) {
	  ...
	  var errorsArray = [];
	  iterate(errors, push$t, { that: errorsArray });
	...
	_export({ global: true, constructor: true, arity: 2, forced: FORCED$I }, {
	...
	var $SuppressedError = function SuppressedError(error, suppressed, message) {
	  ...
	  var that;
	  if (objectSetPrototypeOf) {
	    that = PATCH$1 && (!isInstance || objectGetPrototypeOf(this) === SuppressedErrorPrototype)
	      ? new NativeSuppressedError()
	      : objectSetPrototypeOf(new $Error(), isInstance ? objectGetPrototypeOf(this) : SuppressedErrorPrototype);
	  } else {
	    that = isInstance ? this : objectCreate(SuppressedErrorPrototype);
	    createNonEnumerableProperty(that, TO_STRING_TAG$7, 'Error');
	  }
	  if (message !== undefined) { createNonEnumerableProperty(that, 'message', normalizeStringArgument(message)); }
	...
	var SuppressedErrorPrototype = $SuppressedError.prototype = PATCH$1 ? NativeSuppressedError.prototype : objectCreate($Error.prototype, {
	  constructor: createPropertyDescriptor(1, $SuppressedError),
	  message: createPropertyDescriptor(1, ''),
	  name: createPropertyDescriptor(1, 'SuppressedError')
	});

	if (PATCH$1 && !isPure) { SuppressedErrorPrototype.constructor = $SuppressedError; }

	// `SuppressedError` constructor
	// https://github.com/tc39/proposal-explicit-resource-management
	_export({ global: true, constructor: true, arity: 3, forced: PATCH$1 }, {
	...
	var FORCED$H = !IS_CONCAT_SPREADABLE_SUPPORT || !arrayMethodHasSpeciesSupport('concat');

	// `Array.prototype.concat` method
	// https://tc39.es/ecma262/#sec-array.prototype.concat
	// with adding support of @@isConcatSpreadable and @@species
	_export({ target: 'Array', proto: true, arity: 1, forced: FORCED$H }, {
	  // eslint-disable-next-line no-unused-vars -- required for `.length`
	...
	var deletePropertyOrThrow = function (O, P) {
	  if (!delete O[P]) { throw new $TypeError$F('Cannot delete property ' + tryToString(P) + ' of ' + tryToString(O)); }
	};
	...
	var FORCED$G = NEGATIVE_ZERO$1 || !arrayMethodIsStrict('indexOf');
	...
	var NEW_ITERATOR_PROTOTYPE = !isObject(IteratorPrototype$6) || fails(function () {
	  var test = {};
	...
	var FORCED$F = ES3_STRINGS || !arrayMethodIsStrict('join', ',');

	// `Array.prototype.join` method
	// https://tc39.es/ecma262/#sec-array.prototype.join
	_export({ target: 'Array', proto: true, forced: FORCED$F }, {
	...
	var FORCED$E = NEGATIVE_ZERO || !STRICT_METHOD$2;
	...
	var arraySetLength = SILENT_ON_NON_WRITABLE_LENGTH_SET ? function (O, length) {
	  if (isArray$1(O) && !getOwnPropertyDescriptor$9(O, 'length').writable) {
	...
	_export({ target: 'Array', proto: true, arity: 1, forced: FORCED$D }, {
	  // eslint-disable-next-line no-unused-vars -- required for `.length`
	...
	var FORCED$C = CHROME_BUG$1 || !arrayMethodIsStrict('reduce');

	// `Array.prototype.reduce` method
	// https://tc39.es/ecma262/#sec-array.prototype.reduce
	_export({ target: 'Array', proto: true, forced: FORCED$C }, {
	...
	var FORCED$B = CHROME_BUG || !arrayMethodIsStrict('reduceRight');
	...
	_export({ target: 'Array', proto: true, forced: !HAS_SPECIES_SUPPORT$1 }, {
	  slice: function slice(start, end) {
	    ...
	    if (isArray$1(O)) {
	      ...
	      // cross-realm fallback
	      if (isConstructor(Constructor) && (Constructor === $Array$a || isArray$1(Constructor.prototype))) {
	...
	var push$s = functionUncurryThis(test.push);
	...
	var FORCED$A = FAILS_ON_UNDEFINED || !FAILS_ON_NULL || !STRICT_METHOD || !STABLE_SORT$1;
	...
	var FORCED$z = INCORRECT_RESULT || !properErrorOnNonWritableLength();

	// `Array.prototype.unshift` method
	// https://tc39.es/ecma262/#sec-array.prototype.unshift
	_export({ target: 'Array', proto: true, arity: 1, forced: FORCED$z }, {
	  // eslint-disable-next-line no-unused-vars -- required for `.length`
	...
	// https://tc39.es/ecma262/#sec-array.prototype.with
	_export({ target: 'Array', proto: true, forced: INCORRECT_EXCEPTION_ON_COERCION_FAIL }, {
	...
	_export({ global: true, constructor: true, forced: NativeArrayBuffer !== ArrayBuffer$5 }, {
	...
	if (descriptors && !hasOwnProperty_1(TypedArrayPrototype$1, TO_STRING_TAG$6)) {
	  TYPED_ARRAY_TAG_REQUIRED = true;
	  defineBuiltInAccessor(TypedArrayPrototype$1, TO_STRING_TAG$6, {
	    configurable: true,
	    get: function () {
	...
	var arrayBufferNotDetached = function (it) {
	  if (arrayBufferIsDetached(it)) { throw new $TypeError$A('ArrayBuffer is detached'); }
	  return it;
	};
	...
	var slice$7 = functionUncurryThis(ArrayBufferPrototype.slice);
	...
	var arrayBufferTransfer = (structuredCloneProperTransfer || detachTransferable) && function (arrayBuffer, newLength, preserveResizability) {
	  ...
	  if (byteLength >= newByteLength && (!preserveResizability || fixedLength)) {
	    newBuffer = slice$7(arrayBuffer, 0, newByteLength);
	  } else {
	...
	_export({ target: 'Date', proto: true, forced: FORCED$y }, {
	...
	_export({ target: 'Date', proto: true, arity: 1, forced: FORCED$x }, {
	  // eslint-disable-next-line no-unused-vars -- required for `.length`
	...
	var $DisposableStack = function DisposableStack() {
	  setInternalState$i(anInstance(this, DisposableStackPrototype), {
	...
	defineBuiltIn(DisposableStackPrototype, TO_STRING_TAG$5, DISPOSABLE_STACK, { nonWritable: true });
	...
	var numberToString$4 = functionUncurryThis(1.1.toString);
	...
	var NativeIterator = globalThis_1[ITERATOR$7];

	// FF56- have non-standard global helper `Iterator`
	var FORCED$w = !isCallable(NativeIterator)
	...
	var IteratorConstructor = function Iterator() {
	  ...
	  if (objectGetPrototypeOf(this) === IteratorPrototype$3) { throw new $TypeError$y('Abstract class Iterator not directly constructable'); }
	};
	...
	if (!hasOwnProperty_1(IteratorPrototype$3, TO_STRING_TAG$4)) { defineIteratorPrototypeAccessor(TO_STRING_TAG$4, ITERATOR$7); }

	if (FORCED$w || !hasOwnProperty_1(IteratorPrototype$3, CONSTRUCTOR) || IteratorPrototype$3[CONSTRUCTOR] === Object) {
	...
	_export({ global: true, constructor: true, forced: FORCED$w }, {
	...
	if (!hasOwnProperty_1(IteratorPrototype$2, DISPOSE)) {
	  defineBuiltIn(IteratorPrototype$2, DISPOSE, function () {
	...
	var iteratorCloseAll = function (iters, kind, value) {
	  ...
	  return defineBuiltIns(objectCreate(IteratorPrototype$1), {
	    ...
	    'return': function () {
	      ...
	      if (state.inner) { try {
	        ...
	        return iteratorClose(iterator, THROW$3, error);
	      } }
	      if (state.openIters) { try {
	        iteratorCloseAll(state.openIters, NORMAL);
	      } catch (error$1) {
	        return iteratorClose(iterator, THROW$3, error$1);
	      } }
	      if (iterator) { iteratorClose(iterator, NORMAL); }
	      return createIterResultObject(undefined, true);
	    }
	...
	var iteratorHelperThrowsOnInvalidIterator = function (methodName, argument) {
	...
	var iteratorHelperWithoutClosingOnEarlyError = function (METHOD_NAME, ExpectedError) {
	  var Iterator = globalThis_1.Iterator;
	...
	var FORCED$v = DROP_WITHOUT_THROWING_ON_INVALID_ITERATOR || dropWithoutClosingOnEarlyError;

	var IteratorProxy$9 = iteratorCreateProxy(function () {
	...
	_export({ target: 'Iterator', proto: true, real: true, forced: FORCED$v }, {
	  drop: function drop(limit) {
	    ...
	    if (dropWithoutClosingOnEarlyError) { return functionCall(dropWithoutClosingOnEarlyError, this, remaining); }

	    return new IteratorProxy$9(getIteratorDirect(this), {
	      remaining: remaining
	    });
	  }
	});
	...
	_export({ target: 'Iterator', proto: true, real: true, forced: everyWithoutClosingOnEarlyError }, {
	  every: function every(predicate) {
	    ...
	    if (everyWithoutClosingOnEarlyError) { return functionCall(everyWithoutClosingOnEarlyError, this, predicate); }
	...
	var FORCED$u = FILTER_WITHOUT_THROWING_ON_INVALID_ITERATOR || filterWithoutClosingOnEarlyError;

	var IteratorProxy$8 = iteratorCreateProxy(function () {
	  var iterator = this.iterator;
	...
	_export({ target: 'Iterator', proto: true, real: true, forced: FORCED$u }, {
	  filter: function filter(predicate) {
	    ...
	    if (filterWithoutClosingOnEarlyError) { return functionCall(filterWithoutClosingOnEarlyError, this, predicate); }

	    return new IteratorProxy$8(getIteratorDirect(this), {
	      predicate: predicate
	    });
	  }
	});
	...
	_export({ target: 'Iterator', proto: true, real: true, forced: findWithoutClosingOnEarlyError }, {
	  find: function find(predicate) {
	    ...
	    if (findWithoutClosingOnEarlyError) { return functionCall(findWithoutClosingOnEarlyError, this, predicate); }
	...
	var FORCED$t = FLAT_MAP_WITHOUT_THROWING_ON_INVALID_ITERATOR || flatMapWithoutClosingOnEarlyError;

	var IteratorProxy$7 = iteratorCreateProxy(function () {
	  var iterator = this.iterator;
	...
	_export({ target: 'Iterator', proto: true, real: true, forced: FORCED$t }, {
	  flatMap: function flatMap(mapper) {
	    ...
	    if (flatMapWithoutClosingOnEarlyError) { return functionCall(flatMapWithoutClosingOnEarlyError, this, mapper); }

	    return new IteratorProxy$7(getIteratorDirect(this), {
	      mapper: mapper,
	      inner: null
	    });
	  }
	...
	_export({ target: 'Iterator', proto: true, real: true, forced: forEachWithoutClosingOnEarlyError }, {
	  forEach: function forEach(fn) {
	    ...
	    if (forEachWithoutClosingOnEarlyError) { return functionCall(forEachWithoutClosingOnEarlyError, this, fn); }
	...
	_export({ target: 'Iterator', stat: true, forced: FORCED$s }, {
	...
	var FORCED$r = MAP_WITHOUT_THROWING_ON_INVALID_ITERATOR || mapWithoutClosingOnEarlyError;
	...
	_export({ target: 'Iterator', proto: true, real: true, forced: FORCED$r }, {
	  map: function map(mapper) {
	    ...
	    if (mapWithoutClosingOnEarlyError) { return functionCall(mapWithoutClosingOnEarlyError, this, mapper); }
	...
	var reduceWithoutClosingOnEarlyError = !FAILS_ON_INITIAL_UNDEFINED && iteratorHelperWithoutClosingOnEarlyError('reduce', $TypeError$x);

	// `Iterator.prototype.reduce` method
	// https://tc39.es/ecma262/#sec-iterator.prototype.reduce
	_export({ target: 'Iterator', proto: true, real: true, forced: FAILS_ON_INITIAL_UNDEFINED || reduceWithoutClosingOnEarlyError }, {
	  reduce: function reduce(reducer /* , initialValue */) {
	    ...
	    if (reduceWithoutClosingOnEarlyError) {
	      return functionApply(reduceWithoutClosingOnEarlyError, this, noInitial ? [reducer] : [reducer, accumulator]);
	    }
	    var record = getIteratorDirect(this);
	    var counter = 0;
	    iterate(record, function (value) {
	...
	_export({ target: 'Iterator', proto: true, real: true, forced: someWithoutClosingOnEarlyError }, {
	  some: function some(predicate) {
	    ...
	    if (someWithoutClosingOnEarlyError) { return functionCall(someWithoutClosingOnEarlyError, this, predicate); }
	...
	_export({ target: 'Iterator', proto: true, real: true, forced: takeWithoutClosingOnEarlyError }, {
	  take: function take(limit) {
	    ...
	    if (takeWithoutClosingOnEarlyError) { return functionCall(takeWithoutClosingOnEarlyError, this, remaining); }
	...
	_export({ target: 'Iterator', proto: true, real: true }, {
	  toArray: function toArray() {
	    var result = [];
	    iterate(getIteratorDirect(anObject(this)), push$q, { that: result, IS_RECORD: true });
	    return result;
	  }
	});
	...
	var has$g = mapHelpers.has;
	var get$8 = mapHelpers.get;
	var set$e = mapHelpers.set;
	...
	_export({ target: 'Map', stat: true, forced: DOES_NOT_WORK_WITH_PRIMITIVES$1 }, {
	...
	_export({ target: 'Math', stat: true, forced: FORCED$q }, {
	...
	_export({ target: 'Math', stat: true, forced: FORCED$p }, {
	  asinh: asinh
	});
	...
	_export({ target: 'Math', stat: true, arity: 2, forced: FORCED$m }, {
	  // eslint-disable-next-line no-unused-vars -- required for `.length`
	...
	var thisNumberValue$1 = functionUncurryThis(1.1.valueOf);
	...
	var toNumber = function (argument) {
	  ...
	  if (isSymbol(it)) { throw new TypeError$6('Cannot convert a Symbol value to a number'); }
	...
	var FORCED$j = isForced_1(NUMBER, !NativeNumber(' 0o1') || !NativeNumber('0b1') || NativeNumber('+0x1'));
	...
	if (FORCED$j && !isPure) { NumberPrototype.constructor = NumberWrapper; }

	_export({ global: true, constructor: true, wrap: true, forced: FORCED$j }, {
	...
	if (FORCED$j || isPure) { copyConstructorProperties(path[NUMBER], NativeNumber); }
	...
	var Symbol$4 = globalThis_1.Symbol;
	var ITERATOR$6 = Symbol$4 && Symbol$4.iterator;
	var FORCED$i = 1 / $parseFloat(whitespaces$1 + '-0') !== -Infinity
	...
	var Symbol$3 = globalThis_1.Symbol;
	var ITERATOR$5 = Symbol$3 && Symbol$3.iterator;
	var hex = /^[+-]?0x/i;
	var exec$d = functionUncurryThis(hex.exec);
	var FORCED$h = $parseInt$3(whitespaces$1 + '08') !== 8 || $parseInt$3(whitespaces$1 + '0x16') !== 22
	  // MS Edge 18- broken with boxed symbols
	  || (ITERATOR$5 && !fails(function () { $parseInt$3(Object(ITERATOR$5)); }));
	...
	var nativeToExponential = functionUncurryThis(1.1.toExponential);
	...
	_export({ target: 'Number', proto: true, forced: FORCED$g }, {
	...
	var nativeToFixed = functionUncurryThis(1.1.toFixed);
	...
	var nativeToPrecision = functionUncurryThis(1.1.toPrecision);
	  ...
	  return function (it) {
	    ...
	    while (length > i) {
	      ...
	      if (!descriptors || (IE_WORKAROUND ? key in O : propertyIsEnumerable(O, key))) {
	        push$o(result, TO_ENTRIES ? [key, O[key]] : O[key]);
	      }
	    }
	    return result;
	  };
	...
	var FORCED$d = !descriptors || fails(function () { nativeGetOwnPropertyDescriptor(1); });
	...
	var create$2 = getBuiltIn('Object', 'create');
	...
	_export({ target: 'Object', stat: true, forced: DOES_NOT_WORK_WITH_PRIMITIVES }, {
	  groupBy: function groupBy(items, callbackfn) {
	    requireObjectCoercible(items);
	    aCallable(callbackfn);
	    ...
	    iterate(items, function (value) {
	      ...
	      if (key in obj) { push$n(obj[key], value); }
	      else { obj[key] = [value]; }
	    });
	    return obj;
	  }
	...
	var FORCED$c = arrayBufferNonExtensible || fails(function () { $isFrozen(1); });

	// `Object.isFrozen` method
	// https://tc39.es/ecma262/#sec-object.isfrozen
	_export({ target: 'Object', stat: true, forced: FORCED$c }, {
	...
	var FORCED$b = arrayBufferNonExtensible || fails(function () { $isSealed(1); });
	...
	var aConstructor = function (argument) {
	  ...
	  throw new $TypeError$w(tryToString(argument) + ' is not a constructor');
	};
	...
	var set$d = globalThis_1.setImmediate;
	...
	var safeGetBuiltIn = function (name) {
	  ...
	  var descriptor = getOwnPropertyDescriptor$5(globalThis_1, name);
	...
	var Promise$7 = globalThis_1.Promise;
	...
	if (!microtask) {
	  ...
	  } else if (!environmentIsIosPebble && Promise$7 && Promise$7.resolve) {
	...
	var Promise$6 = globalThis_1.Promise;

	var ACCEPT_ARGUMENTS = false;
	// Avoiding the use of polyfills of the previous iteration of this proposal
	// that does not accept arguments of the callback
	var FORCED$a = !Promise$6 || !Promise$6['try'] || perform(function () {
	...
	var getInternalState$b = internalState.getterFor(ASYNC_FROM_SYNC_ITERATOR);
	...
	var AsyncFromSyncIterator = function AsyncIterator(iteratorRecord) {
	  ...
	  setInternalState$e(this, iteratorRecord);
	};
	...
	// https://github.com/tc39/proposal-array-from-async
	_export({ target: 'Array', stat: true, forced: INCORRECT_CONSTRUCTURING }, {
	...
	var $AsyncDisposableStack = function AsyncDisposableStack() {
	  setInternalState$d(anInstance(this, AsyncDisposableStackPrototype), {
	...
	defineBuiltIn(AsyncDisposableStackPrototype, TO_STRING_TAG$2, ASYNC_DISPOSABLE_STACK, { nonWritable: true });
	...
	_export({ global: true, constructor: true, forced: SYNC_DISPOSE_RETURNING_PROMISE_RESOLUTION_BUG }, {
	...
	_export({ target: 'Reflect', stat: true, forced: FORCED$9, sham: FORCED$9 }, {
	  construct: function construct(Target, args /* , newTarget */) {
	    ...
	    if (Target === newTarget) {
	      ...
	      var $args = [null];
	      functionApply(push$m, $args, args);
	...
	function get$7(target, propertyKey /* , receiver */) {
	  ...
	  if (isObject(prototype = objectGetPrototypeOf(target))) { return get$7(prototype, propertyKey, receiver); }
	}
	...
	var regexpGetFlags = regexpFlagsDetection.correct ? function (it) {
	  ...
	  return (!regexpFlagsDetection.correct && objectIsPrototypeOf(RegExpPrototype$6, it) && !hasOwnProperty_1(it, 'flags'))
	...
	var exec$c = functionUncurryThis(RegExpPrototype$5.exec);
	...
	if (isForced_1('RegExp', BASE_FORCED)) {
	  var RegExpWrapper = function RegExp(pattern, flags) {
	    var thisIsRegExp = objectIsPrototypeOf(RegExpPrototype$5, this);
	    ...
	    if (patternIsRegExp || objectIsPrototypeOf(RegExpPrototype$5, pattern)) {
	    ...
	    result = inheritIfRequired(NativeRegExp(pattern, flags), thisIsRegExp ? this : RegExpPrototype$5, RegExpWrapper);
	...
	var aString = function (argument) {
	  ...
	  throw new $TypeError$t('Argument is not a string');
	};
	...
	_export({ target: 'RegExp', stat: true, forced: FORCED$8 }, {
	...
	if (descriptors && regexpUnsupportedDotAll) {
	  defineBuiltInAccessor(RegExpPrototype$4, 'dotAll', {
	    configurable: true,
	    get: function dotAll() {
	...
	var forEach$3 = functionUncurryThis(SetPrototype.forEach);
	var keys = functionUncurryThis(SetPrototype.keys);
	var next$1 = keys(new Set$7()).next;

	var setIterate = function (set, fn, interruptible) {
	  return interruptible ? iterateSimple({ iterator: keys(set), next: next$1 }, fn) : forEach$3(set, fn);
	};
	...
	var getSetRecord = function (obj) {
	  ...
	  // eslint-disable-next-line no-self-compare -- NaN check
	  if (numSize !== numSize) { throw new $TypeError$q(INVALID_SIZE); }
	...
	var setMethodAcceptSetLike = function (name, callback) {
	...
	var FORCED$7 = SET_LIKE_INCORRECT_BEHAVIOR || fails(function () {
	...
	// `Set.prototype.difference` method
	// https://tc39.es/ecma262/#sec-set.prototype.difference
	_export({ target: 'Set', proto: true, real: true, forced: FORCED$7 }, {
	...
	// `Set.prototype.intersection` method
	// https://tc39.es/ecma262/#sec-set.prototype.intersection
	_export({ target: 'Set', proto: true, real: true, forced: INCORRECT$3 }, {
	...
	var setIsDisjointFrom = function isDisjointFrom(other) {
	  ...
	  return iterateSimple(iterator, function (e) {
	    if (has$c(O, e)) { return iteratorClose(iterator, 'normal', false); }
	  }) !== false;
	};
	...
	// `Set.prototype.isDisjointFrom` method
	// https://tc39.es/ecma262/#sec-set.prototype.isdisjointfrom
	_export({ target: 'Set', proto: true, real: true, forced: INCORRECT$2 }, {
	...
	// `Set.prototype.isSubsetOf` method
	// https://tc39.es/ecma262/#sec-set.prototype.issubsetof
	_export({ target: 'Set', proto: true, real: true, forced: INCORRECT$1 }, {
	...
	var FORCED$6 = !setMethodAcceptSetLike('symmetricDifference') || !setMethodGetKeysBeforeCloningDetection('symmetricDifference');

	// `Set.prototype.symmetricDifference` method
	// https://tc39.es/ecma262/#sec-set.prototype.symmetricdifference
	_export({ target: 'Set', proto: true, real: true, forced: FORCED$6 }, {
	...
	var FORCED$5 = !setMethodAcceptSetLike('union') || !setMethodGetKeysBeforeCloningDetection('union');

	// `Set.prototype.union` method
	// https://tc39.es/ecma262/#sec-set.prototype.union
	_export({ target: 'Set', proto: true, real: true, forced: FORCED$5 }, {
	  union: setUnion
	});
	...
	var notARegexp = function (it) {
	  if (isRegexp(it)) {
	    throw new $TypeError$p("The method doesn't accept regular expressions");
	  } return it;
	};
	...
	var regexpExecAbstract = function (R, S) {
	  ...
	  throw new $TypeError$o('RegExp#exec called on incompatible receiver');
	};
	...
	fixRegexpWellKnownSymbolLogic('match', function (MATCH, nativeMatch, maybeCallNative) {
	  return [
	    ...
	    function (string) {
	      ...
	      if (stringIndexOf$3(flags, 'g') === -1) { return regexpExecAbstract(rx, S); }
	...
	_export({ target: 'String', stat: true }, {
	  raw: function raw(template) {
	    ...
	    var i = 0;
	    while (true) {
	      push$l(elements, toString_1(rawTemplate[i++]));
	      if (i === literalSegments) { return join$6(elements, ''); }
	      if (i < argumentsLength) { push$l(elements, toString_1(arguments$1[i])); }
	    }
	  }
	});
	...
	fixRegexpWellKnownSymbolLogic('replace', function (_, nativeReplace, maybeCallNative) {
	  ...
	  return [
	    ...
	    function replace(searchValue, replaceValue) {
	      var O = requireObjectCoercible(this);
	      var replacer = isObject(searchValue) ? getMethod(searchValue, REPLACE$1) : undefined;
	      return replacer
	    ...
	    function (string, replaceValue) {
	      ...
	      for (var i = 0; i < results.length; i++) {
	        ...
	        for (var j = 1; j < result.length; j++) { push$k(captures, maybeToString(result[j])); }
	        var namedCaptures = result.groups;
	        if (functionalReplace) {
	          var replacerArgs = concat$2([matched], captures, position, S);
	          if (namedCaptures !== undefined) { push$k(replacerArgs, namedCaptures); }
	  ...
	  replaceAll: function replaceAll(searchValue, replaceValue) {
	    ...
	    if (isObject(searchValue)) {
	      ...
	      if (IS_REG_EXP) {
	        ...
	        if (!~indexOf(flags, 'g')) { throw new $TypeError$m('`.replaceAll` does not allow non-global regexes'); }
	      }
	...
	var toBigInt = function (argument) {
	  ...
	  if (typeof prim == 'number') { throw new $TypeError$l("Can't convert number to bigint"); }
	...
	var arrayGroup = function ($this, callbackfn, that, specificConstructor) {
	  ...
	  for (;length > index; index++) {
	    ...
	    // in some IE versions, `hasOwnProperty` returns incorrect result on integer keys
	    // but since it's a `null` prototype object, we can safely use `in`
	    if (key in target) { push$i(target[key], value); }
	...
	var arrayGroupToMap = function groupToMap(callbackfn /* , thisArg */) {
	  ...
	  for (;length > index; index++) {
	    ...
	    if (mapHas$2(map, key)) { push$h(mapGet$1(map, key), value); }
	...
	var AsyncIteratorConstructor = function AsyncIterator() {
	  ...
	  if (objectGetPrototypeOf(this) === asyncIteratorPrototype) { throw new $TypeError$k('Abstract class AsyncIterator not directly constructable'); }
	};

	AsyncIteratorConstructor.prototype = asyncIteratorPrototype;

	if (!hasOwnProperty_1(asyncIteratorPrototype, TO_STRING_TAG$1)) {
	      ...
	      var loop = function () {
	        try {
	          Promise$1.resolve(anObject(functionCall(next, iterator))).then(function (step) {
	            try {
	              if (anObject(step).done) {
	                noInitial ? reject(new $TypeError$j('Reduce of empty iterator with no initial value')) : resolve(accumulator);
	              } else {
	                var value = step.value;
	                if (noInitial) {
	                  noInitial = false;
	...
	var $RangeIterator = iteratorCreateConstructor(function NumericRangeIterator(start, end, option, type, zero, one) {
	  ...
	  if (start === Infinity || start === -Infinity) {
	    throw new $RangeError$5(INCORRECT_RANGE);
	  }
	...
	var compositeKey = function () {
	  ...
	  if (this === $Object$2 && active === root) { throw new $TypeError$h('Composite keys must contain a non-primitive component'); }
	  for (i = 0; i < length; i++) {
	...
	var iteratorIndexed = function indexed() {
	  return functionCall(map, this, callback);
	};
	...
	_export({ target: 'Iterator', proto: true, real: true, forced: true }, {
	  chunks: function chunks(chunkSize) {
	    ...
	    if (typeof chunkSize != 'number' || !chunkSize || chunkSize >>> 0 !== chunkSize) {
	      return iteratorClose(O, 'throw', new $RangeError$4('chunkSize must be integer in [1, 2^32-1]'));
	    }
	    return new IteratorProxy$3(getIteratorDirect(O), {
	      chunkSize: chunkSize
	    });
	  }
	});
	...
	_export({ target: 'Iterator', stat: true, forced: true }, {
	  concat: function concat() {
	    ...
	    for (var index = 0; index < length; index++) {
	      var item = anObject(arguments$1[index]);
	      iterables[index] = {
	        iterable: item,
	...
	_export({ target: 'Iterator', stat: true, forced: true }, {
	  range: function range(start, end, option) {
	    ...
	    throw new $TypeError$g('Incorrect Iterator.range arguments');
	  }
	});
	...
	// https://github.com/tc39/proposal-iterator-chunking
	var iteratorWindow = function (O, windowSize, sliding) {
	  anObject(O);
	  if (typeof windowSize != 'number' || !windowSize || windowSize >>> 0 !== windowSize) {
	    return iteratorClose(O, 'throw', new $RangeError$3('windowSize must be integer in [1, 2^32-1]'));
	  }
	  return new IteratorProxy$1(getIteratorDirect(O), {
	...
	var anObjectOrUndefined = function (argument) {
	  ...
	  throw new $TypeError$f($String$1(argument) + ' is not an object or undefined');
	};

	var getIteratorRecord = function (argument) {
	  return getIteratorDirect(getIterator(argument));
	};

	var $TypeError$e = TypeError;

	var getModeOption = function (options) {
	  var mode = options && options.mode;
	  if (mode === undefined || mode === 'shortest' || mode === 'longest' || mode === 'strict') { return mode || 'shortest'; }
	  throw new $TypeError$e('Incorrect `mode` option');
	};
	...
	var IteratorProxy = iteratorCreateProxy(function () {
	  ...
	  for (var i = 0; i < iterCount; i++) {
	    var iter = iters[i];
	    if (iter === null) {
	      push$d(results, padding[i]);
	    } else {
	      try {
	        result = functionCall(iter.next, iter.iterator);
	        done = result.done;
	        result = result.value;
	      } catch (error) {
	        openIters[i] = undefined;
	        return iteratorCloseAll(openIters, THROW$2, error);
	      }
	      if (done) {
	        openIters[i] = undefined;
	        this.openItersCount--;
	        ...
	        if (mode === 'strict') {
	          if (i) {
	            return iteratorCloseAll(openIters, THROW$2, new $TypeError$d(ITERATOR_IS_EXHAUSTED));
	          }
	          ...
	          for (var k = 1; k < iterCount; k++) {
	            ...
	            try {
	              open = functionCall(iters[k].next, iters[k].iterator);
	              openDone = open.done;
	              open = open.value;
	            } catch (error$1) {
	              openIters[k] = undefined;
	              return iteratorCloseAll(openIters, THROW$2, open);
	            }
	            // eslint-disable-next-line max-depth -- specification case
	            if (openDone) {
	              openIters[k] = undefined;
	...
	var iteratorZip = function (iters, mode, padding, finishResults) {
	...
	_export({ target: 'Iterator', stat: true, forced: true }, {
	  zip: function zip(iterables /* , options */) {
	    ...
	    while (!done) {
	      try {
	        next = anObject(functionCall(inputIter.next, inputIter.iterator));
	        done = next.done;
	      } catch (error) {
	        return iteratorCloseAll(iters, THROW$1, error);
	      }
	      if (!done) {
	        try {
	          iter = getIteratorFlattenable(next.value, true);
	        } catch (error$1) {
	          return iteratorCloseAll(concat$1([inputIter.iterator], iters), THROW$1, error$1);
	        }
	        push$c(iters, iter);
	      }
	    }
	    ...
	    if (mode === 'longest') {
	      if (paddingOption === undefined) {
	        for (i = 0; i < iterCount; i++) { push$c(padding, undefined); }
	      } else {
	        try {
	          paddingIter = getIteratorRecord(paddingOption);
	        } catch (error$2) {
	          return iteratorCloseAll(iters, THROW$1, error$2);
	        }
	        var usingIterator = true;
	        for (i = 0; i < iterCount; i++) {
	          if (usingIterator) {
	            try {
	              next = anObject(functionCall(paddingIter.next, paddingIter.iterator));
	              paddingDone = next.done;
	              next = next.value;
	            } catch (error$3) {
	              return iteratorCloseAll(iters, THROW$1, error$3);
	            }
	            if (paddingDone) {
	              usingIterator = false;
	            } else {
	        ...
	        if (usingIterator) {
	          try {
	            ...
	            return iteratorCloseAll(iters, THROW$1, error$4);
	          }
	        }
	      }
	    }
	...
	_export({ target: 'Iterator', stat: true, forced: true }, {
	  zipKeyed: function zipKeyed(iterables /* , options */) {
	    ...
	    for (i = 0; i < allKeys.length; i++) { try {
	      key = allKeys[i];
	      if (!functionCall(propertyIsEnumerable, iterables, key)) { continue; }
	      value = iterables[key];
	      if (value !== undefined) {
	        push$b(keys, key);
	        push$b(iters, getIteratorFlattenable(value, true));
	      }
	    } catch (error) {
	      ...
	      if (paddingOption === undefined) {
	        ...
	        for (i = 0; i < keys.length; i++) {
	          try {
	            ...
	            return iteratorCloseAll(iters, THROW, error$1);
	          }
	          push$b(padding, value);
	        }
	      }
	    }
	...
	var $parse = function (source, reviver) {
	  ...
	  var context = new Context$1(source, 0);
	...
	var Context$1 = function (source, index) {
	  this.source = source;
	  this.index = index;
	};
	...
	Context$1.prototype = {
	  fork: function (nextIndex) {
	    return new Context$1(this.source, nextIndex);
	  },
	  parse: function () {
	...
	if ($stringify) { _export({ target: 'JSON', stat: true, arity: 3, forced: !nativeRawJson }, {
	  stringify: function stringify(text, replacer, space) {
	    ...
	    var json = $stringify(text, function (key, value) {
	      // some old implementations (like WebKit) could pass numbers as keys
	      var v = isCallable(replacerFunction) ? functionCall(replacerFunction, this, $String(key), value) : value;
	...
	_export({ target: 'Map', proto: true, real: true, forced: true }, {
	  deleteAll: function deleteAll(/* ...elements */) {
	    ...
	    for (var k = 0, len = arguments.length; k < len; k++) {
	      wasDeleted = remove$4(collection, arguments$1[k]);
	...
	_export({ target: 'Map', proto: true, real: true, forced: true }, {
	  getOrInsert: function getOrInsert(key, value) {
	    if (has$7(aMap(this), key)) { return get$5(this, key); }
	...
	_export({ target: 'Map', proto: true, real: true, arity: 1, forced: true }, {
	  ...
	  merge: function merge(iterable /* ...iterables */) {
	    ...
	    while (i < argumentsLength) {
	      iterate(arguments$1[i++], function (key, value) {
	        set$5(map, key, value);
	      }, { AS_ENTRIES: true });
	    }
	    return map;
	...
	_export({ target: 'Map', proto: true, real: true, forced: true }, {
	  reduce: function reduce(callbackfn /* , initialValue */) {
	    ...
	    if (noInitial) { throw new $TypeError$c('Reduce of empty map with no initial value'); }
	    return accumulator;
	  }
	});
	...
	var aNumber = function (argument) {
	  if (typeof argument == 'number') { return argument; }
	  throw new $TypeError$9('Argument is not a number');
	};
	...
	_export({ target: 'Math', stat: true, forced: true }, {
	  seededPRNG: function seededPRNG(it) {
	    ...
	    if (!numberIsFinite(seed)) { throw new $TypeError$8(SEED_TYPE_ERROR); }
	...
	_export({ target: 'Math', stat: true }, {
	  ...
	  sumPrecise: function sumPrecise(items) {
	    ...
	    iterate(items, function (n) {
	      ...
	      if (typeof n != 'number') { throw new $TypeError$7('Value is not a number'); }
	...
	// https://github.com/tc39/proposal-math-clamp
	_export({ target: 'Number', proto: true, forced: true }, {
	  clamp: function clamp(min, max) {
	    return mathClamp(thisNumberValue$1(this), min, max);
	  }
	});
	...
	_export({ target: 'Number', stat: true, forced: true }, {
	  fromString: function fromString(string, radix) {
	    var sign = 1;
	    if (typeof string != 'string') { throw new $TypeError$6(INVALID_NUMBER_REPRESENTATION); }
	...
	_export({ target: 'Set', proto: true, real: true, forced: true }, {
	  deleteAll: function deleteAll(/* ...elements */) {
	    ...
	    var wasDeleted;
	    for (var k = 0, len = arguments.length; k < len; k++) {
	      wasDeleted = remove$3(collection, arguments$1[k]);
	      allDeleted = allDeleted && wasDeleted;
	    } return !!allDeleted;
	  }
	});
	...
	_export({ target: 'Set', proto: true, real: true, forced: true }, {
	  reduce: function reduce(callbackfn /* , initialValue */) {
	    ...
	    if (noInitial) { throw new $TypeError$5('Reduce of empty set with no initial value'); }
	    return accumulator;
	  }
	});
	...
	var stringCooked = function cooked(template /* , ...substitutions */) {
	  ...
	  while (true) {
	    ...
	    if (nextVal === undefined) { throw new $TypeError$4('Incorrect template'); }
	    push$5(elements, toString_1(nextVal));
	    if (i === literalSegments) { return join$3(elements, ''); }
	    if (i < argumentsLength) { push$5(elements, toString_1(arguments$1[i])); }
	  }
	};
	...
	var dedentTemplateStringsArray = function (template) {
	  ...
	  if (freezing && !isFrozen(rawInput)) { throw new $TypeError$3('Raw template should be frozen'); }
	...
	var dedentStringsArray = function (template) {
	  ...
	  if (!length) { throw new $TypeError$3(INVALID_TAG); }

	  for (; i < length; i++) {
	    var element = t[i];
	    if (typeof element == 'string') { blocks[i] = split$3(element, NEW_LINE); }
	    else { throw new $TypeError$3(INVALID_TAG); }
	  }
	  ...
	  for (i = 0; i < length; i++) {
	    ...
	    if (i === 0) {
	      if (lines.length === 1 || lines[0].length > 0) {
	        throw new $TypeError$3(INVALID_OPENING_LINE);
	      }
	      lines[1] = '';
	    }
	    if (lastSplit) {
	      if (lines.length === 1 || exec$5(NON_WHITESPACE, lines[lines.length - 1])) {
	        throw new $TypeError$3(INVALID_CLOSING_LINE);
	      }
	...
	if (Uint8Array$5) { _export({ target: 'Uint8Array', stat: true, forced: INCORRECT_BEHAVIOR_OR_DOESNT_EXISTS$3 }, {
	...
	// https://github.com/tc39/proposal-arraybuffer-base64
	if (globalThis_1.Uint8Array) { _export({ target: 'Uint8Array', stat: true }, {
	...
	// https://github.com/tc39/proposal-arraybuffer-base64
	if (Uint8Array$3) { _export({ target: 'Uint8Array', proto: true, forced: INCORRECT_BEHAVIOR_OR_DOESNT_EXISTS$2 }, {
	...
	// https://github.com/tc39/proposal-arraybuffer-base64
	if (globalThis_1.Uint8Array) { _export({ target: 'Uint8Array', proto: true }, {
	...
	// https://github.com/tc39/proposal-arraybuffer-base64
	if (Uint8Array$2) { _export({ target: 'Uint8Array', proto: true, forced: INCORRECT_BEHAVIOR_OR_DOESNT_EXISTS$1 }, {
	...
	var numberToString$1 = functionUncurryThis(1.1.toString);
	...
	// https://github.com/tc39/proposal-arraybuffer-base64
	if (Uint8Array$1) { _export({ target: 'Uint8Array', proto: true, forced: INCORRECT_BEHAVIOR_OR_DOESNT_EXISTS }, {
	...
	_export({ target: 'WeakMap', proto: true, real: true, forced: true }, {
	  deleteAll: function deleteAll(/* ...elements */) {
	    ...
	    var wasDeleted;
	    for (var k = 0, len = arguments.length; k < len; k++) {
	      wasDeleted = remove$2(collection, arguments$1[k]);
	      allDeleted = allDeleted && wasDeleted;
	    } return !!allDeleted;
	  }
	});
	...
	var has$3 = weakMapHelpers.has;
	var set$3 = weakMapHelpers.set;
	...
	var set$2 = weakMapHelpers.set;

	// `WeakMap.prototype.getOrInsert` method
	// https://github.com/tc39/proposal-upsert
	_export({ target: 'WeakMap', proto: true, real: true, forced: true }, {
	  getOrInsert: function getOrInsert(key, value) {
	    if (has$2(aWeakMap(this), key)) { return get$1(this, key); }
	...
	_export({ target: 'WeakSet', proto: true, real: true, forced: true }, {
	  deleteAll: function deleteAll(/* ...elements */) {
	    ...
	    var wasDeleted;
	    for (var k = 0, len = arguments.length; k < len; k++) {
	      wasDeleted = remove(collection, arguments$1[k]);
	      allDeleted = allDeleted && wasDeleted;
	    } return !!allDeleted;
	  }
	});
	...
	_export({ global: true, bind: true, enumerable: true, forced: !BASIC || NO_ARG_RECEIVING_CHECK || WRONG_ARG_CONVERSION || WRONG_ARITY$2 }, {
	  btoa: function btoa(data) {
	    validateArgumentsLength(arguments.length, 1);
	    // `webpack` dev server bug on IE global methods - use call(fn, global, ...)
	    if (BASIC) { return functionCall($btoa, globalThis_1, toString_1(data)); }
	...
	_export({ global: true, bind: true, enumerable: true, forced: globalThis_1.clearImmediate !== clearImmediate }, {
	...
	_export({ global: true, bind: true, enumerable: true, forced: globalThis_1.setImmediate !== setImmediate }, {
	...
	_export({ global: true, enumerable: true, dontCallGetSet: true, forced: WRONG_ARITY$1 }, {
	    ...
	    if (INCORRECT_VALUE || !descriptor || !descriptor.get || !descriptor.enumerable) {
	      defineBuiltInAccessor(globalThis_1, 'self', {
	        ...
	        set: function self(value) {
	          ...
	          defineProperty(globalThis_1, 'self', {
	            value: value,
	            writable: true,
	            configurable: true,
	            enumerable: true
	...
	var Error$1 = globalThis_1.Error;
	...
	var thisNumberValue = functionUncurryThis(1.1.valueOf);
	...
	var checkNewErrorsCloningSemantic = function (structuredCloneImplementation) {
	  return !fails(function () {
	    var test = structuredCloneImplementation(new globalThis_1.AggregateError([1], PERFORMANCE_MARK, { cause: 3 }));
	...
	var tryToTransfer = function (rawTransfer, map) {
	  if (!isObject(rawTransfer)) { throw new TypeError$3('Transfer option cannot be converted to a sequence'); }
	...
	var join = functionUncurryThis([].join);
	var numberToString = functionUncurryThis(1.1.toString);
	...
	_export({ target: 'URL', stat: true, forced: !THROWS_WITHOUT_ARGUMENTS || WRONG_ARITY }, {
	...
	// `URL.parse` method
	// https://url.spec.whatwg.org/#dom-url-canparse
	_export({ target: 'URL', stat: true, forced: !urlConstructorDetection }, {

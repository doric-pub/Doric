...
var RefreshableDemo = /*@__PURE__*/(function (Panel) {
    function RefreshableDemo () {
        Panel.apply(this, arguments);
    }

    if ( Panel ) RefreshableDemo.__proto__ = Panel;
    RefreshableDemo.prototype = Object.create( Panel && Panel.prototype );
    RefreshableDemo.prototype.constructor = RefreshableDemo;

    RefreshableDemo.prototype.build = function build (rootView) {
        var refreshImage;
        var refreshView = doric.refreshable({
    ...
    return RefreshableDemo;
}(doric.Panel));
RefreshableDemo = __decorate([
    Entry
], RefreshableDemo);
//# sourceMappingURL=RefreshableDemo.es5.js.map

    ...
    */
    ...
    var clearErrorStack = function (stack, dropEntries) {
      ...
      if (IS_V8_OR_CHAKRA_STACK) {
        ...
        return join$7(arraySliceSimple(split$3(stack, '\n'), dropEntries), '\n');
      } return stack;
    };
    ...
    var getInternalState$c = internalState.getterFor(PROMISE);
    ...
    var getInternalState$5 = internalState.getterFor(ASYNC_ITERATOR_PROXY);
    ...
    var getInternalState$2 = internalState.getterFor(SEEDED_RANDOM_GENERATOR);
    ...
    var getInternalState$1 = internalState.getterFor(OBJECT_ITERATOR);

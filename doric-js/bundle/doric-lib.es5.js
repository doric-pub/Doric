...
var LinearLayout = /** @class */ (function (_super) {
    __extends$j(LinearLayout, _super);
...
var Panel = /** @class */ (function () {
    ...
    Panel.prototype.__restoreRenderSnapshot__ = function (idx) {
        return __spreadArray$3([], __read$3(this.renderSnapshots), false).slice(0, idx);
    };
...
var ScaleAnimation = /** @class */ (function (_super) {
    __extends$i(ScaleAnimation, _super);
...
var TranslationAnimation = /** @class */ (function (_super) {
    __extends$i(TranslationAnimation, _super);
...
var RotationAnimation = /** @class */ (function (_super) {
    __extends$i(RotationAnimation, _super);
...
var RotationXAnimation = /** @class */ (function (_super) {
    __extends$i(RotationXAnimation, _super);
...
var RotationYAnimation = /** @class */ (function (_super) {
    __extends$i(RotationYAnimation, _super);
...
var BackgroundColorAnimation = /** @class */ (function (_super) {
    __extends$i(BackgroundColorAnimation, _super);
...
var AlphaAnimation = /** @class */ (function (_super) {
    __extends$i(AlphaAnimation, _super);
...
var LocalResource = /** @class */ (function (_super) {
    __extends$g(LocalResource, _super);
...
var RemoteResource = /** @class */ (function (_super) {
    __extends$g(RemoteResource, _super);
...
var Base64Resource = /** @class */ (function (_super) {
    __extends$g(Base64Resource, _super);
...
var AssetsResource = /** @class */ (function (_super) {
    __extends$g(AssetsResource, _super);
...
var AndroidResource = /** @class */ (function (_super) {
    __extends$g(AndroidResource, _super);
...
var iOSResource = /** @class */ (function (_super) {
    __extends$g(iOSResource, _super);
...
var DrawableResource = /** @class */ (function (_super) {
    __extends$g(DrawableResource, _super);
...
var RawResource = /** @class */ (function (_super) {
    __extends$g(RawResource, _super);
...
var AndroidAssetsResource = /** @class */ (function (_super) {
    __extends$g(AndroidAssetsResource, _super);
...
var MainBundleResource = /** @class */ (function (_super) {
    __extends$g(MainBundleResource, _super);
...
var BundleResource = /** @class */ (function (_super) {
    __extends$g(BundleResource, _super);
...
var ArrayBufferResource = /** @class */ (function (_super) {
    __extends$g(ArrayBufferResource, _super);
...
var List = /** @class */ (function (_super) {
    ...
    List.prototype.allSubviews = function () {
        var ret = __spreadArray$2([], __read$2(this.cachedViews.values()), false);
...
var Refreshable = /** @class */ (function (_super) {
    __extends$b(Refreshable, _super);
...
var NestedSlider = /** @class */ (function (_super) {
    __extends$7(NestedSlider, _super);
...
var GestureContainer = /** @class */ (function (_super) {
    __extends$4(GestureContainer, _super);
...
var BlurEffect = /** @class */ (function (_super) {
    __extends$3(BlurEffect, _super);
    function BlurEffect() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate$1([
...
var HorizontalListItem = /** @class */ (function (_super) {
    __extends$2(HorizontalListItem, _super);
...
var HorizontalList = /** @class */ (function (_super) {
    __extends$2(HorizontalList, _super);
    ...
    HorizontalList.prototype.allSubviews = function () {
    ...
    HorizontalList.prototype.scrollToItem = function (context, index, config) {
        var animated = config === null || config === void 0 ? void 0 : config.animated;
        return this.nativeChannel(context, 'scrollToItem')({ index: index, animated: animated, });
    };
    /**
     ...
     * @returns Returns array of visible view's index.
     */
    HorizontalList.prototype.findVisibleItems = function (context) {
        return this.nativeChannel(context, 'findVisibleItems')();
    };
    /**
     * @param context
     * @returns Returns array of completely visible view's index.
     */
    HorizontalList.prototype.findCompletelyVisibleItems = function (context) {
        return this.nativeChannel(context, 'findCompletelyVisibleItems')();
    };
    /**
     * Reload all list items.
     ...
     * @returns
     */
    HorizontalList.prototype.reload = function (context) {
        return this.nativeChannel(context, 'reload')();
    };
    HorizontalList.prototype.reset = function () {
        this.cachedViews.clear();
        this.itemCount = 0;
    };
    HorizontalList.prototype.getItem = function (itemIdx) {
        var view = this.renderItem(itemIdx);
        view.superview = this;
        this.cachedViews.set("".concat(itemIdx), view);
        return view;
...
function horizontalList(config) {
    var ret = new HorizontalList;
    ret.apply(config);
    return ret;
}
function horizontalListItem(item, config) {
    return (new HorizontalListItem).also(function (it) {
        it.layoutConfig = layoutConfig().fit();
        if (item instanceof View) {
            it.addChild(item);
        }

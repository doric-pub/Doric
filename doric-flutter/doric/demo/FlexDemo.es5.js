...
var LayoutDemo = /*@__PURE__*/(function (Panel) {
    function LayoutDemo () {
        Panel.apply(this, arguments);
    }

    if ( Panel ) LayoutDemo.__proto__ = Panel;
    LayoutDemo.prototype = Object.create( Panel && Panel.prototype );
    LayoutDemo.prototype.constructor = LayoutDemo;

    LayoutDemo.prototype.build = function build (root) {
        doric.scroller(doric.flexlayout([
            doric.image({
                imageBase64: icon_refresh,
                scaleType: doric.ScaleType.ScaleAspectFit,
                backgroundColor: doric.Color.GRAY,
                layoutConfig: {
            ...
            doric.image({
                ...
                flexConfig: {
                    marginTop: 20,
                    alignContent: doric.Align.CENTER,
                },
                height: 16,
            }) ], {
            flexConfig: {
                ...
                alignItems: doric.Align.FLEX_START,
            },
            backgroundColor: doric.Color.GRAY.alpha(0.1),
        }), {
...
//# sourceMappingURL=FlexDemo.es5.js.map

...
var frameHeight = 300;
var padding = 20;
var MovieVH = /*@__PURE__*/(function (ViewHolder) {
    function MovieVH () {
        ViewHolder.apply(this, arguments);
    }

    if ( ViewHolder ) MovieVH.__proto__ = ViewHolder;
    MovieVH.prototype = Object.create( ViewHolder && ViewHolder.prototype );
    MovieVH.prototype.constructor = MovieVH;

    MovieVH.prototype.build = function build (root) {
        doric.vlayout([
...
var MovieVM = /*@__PURE__*/(function (ViewModel) {
    function MovieVM() {
        ViewModel.apply(this, arguments);
        this.images = new Map;
    }

    if ( ViewModel ) MovieVM.__proto__ = ViewModel;
    MovieVM.prototype = Object.create( ViewModel && ViewModel.prototype );
    MovieVM.prototype.constructor = MovieVM;
    MovieVM.prototype.onAttached = function onAttached (state, vh) {
        var this$1 = this;

        doric.network(context).get("https://douban.uieee.com/v2/movie/top250").then(function (ret) {
            this$1.updateState(function (state) { return state.doubanModel = JSON.parse(ret.data); });
        });
        ...
        var scrollX = 0;
        vh.scrolled.onScroll = function (offset) {
            var _a;
            ...
            var dx = offset.x - scrollX;
            scrollX = offset.x;
            var idx = Math.floor((offset.x + state.anchorPos - padding) / frameWidth);
            if (state.selectedIdx !== idx) {
                this$1.updateState(function (state) { return state.selectedIdx = idx; });
            }
            doric.takeNonNull(this$1.images.get(idx))(function (it) {
                var scale = (offset.x + state.anchorPos - (idx + 0.5) * frameWidth - padding) / (frameWidth / 2);
                it.scaleX = it.scaleY = 1.5 - Math.abs(scale * 0.5);
            });
            this$1.updateArrow();
        };
    };
    MovieVM.prototype.updateArrow = function updateArrow () {
        var this$1 = this;

        doric.takeNonNull(this.images.get(this.getState().selectedIdx))(function (it) {
            it.getLocationOnScreen(context).then(function (ret) {
                this$1.getViewHolder().anchor.centerX = ret.x + frameWidth / 2;
            });
        });
    };
    MovieVM.prototype.onItemClicked = function onItemClicked (idx) {
        var this$1 = this;

        var _a, _b;
        doric.takeNonNull((_a = this.images.get(this.getState().selectedIdx)) === null || _a === void 0 ? void 0 : _a.superview)(function (it) {
            it.scaleX = it.scaleY = 1;
        });
        doric.takeNonNull((_b = this.images.get(idx)) === null || _b === void 0 ? void 0 : _b.superview)(function (it) {
            it.getLocationOnScreen(context).then(function (ret) {
                var anchor = this$1.getState().anchorPos;
                if (ret.x < 0) {
                    this$1.getViewHolder().scrolled.scrollBy(context, { x: ret.x, y: 0 }, true);
                    anchor = frameWidth / 2;
                }
                else if (ret.x > Environment.screenWidth - frameWidth) {
                    this$1.getViewHolder().scrolled.scrollBy(context, { x: ret.x - (Environment.screenWidth - frameWidth), y: 0 }, true);
    ...
    MovieVM.prototype.onBind = function onBind (state, vh) {
        var this$1 = this;
        ...
        if (state.doubanModel) {
            ...
            var vm = this;
            state.doubanModel.subjects.forEach(function (e, idx) {
            ...
            doric.takeNonNull(state.doubanModel.subjects[state.selectedIdx])(function (it) {
...
var SliderPanel = /*@__PURE__*/(function (VMPanel) {
    function SliderPanel () {
        VMPanel.apply(this, arguments);
    }

    if ( VMPanel ) SliderPanel.__proto__ = VMPanel;
    SliderPanel.prototype = Object.create( VMPanel && VMPanel.prototype );
    SliderPanel.prototype.constructor = SliderPanel;

    SliderPanel.prototype.getViewModelClass = function getViewModelClass () {
        return MovieVM;
    };
    SliderPanel.prototype.getViewHolderClass = function getViewHolderClass () {
        return MovieVH;
    };
    SliderPanel.prototype.getState = function getState () {
...
//# sourceMappingURL=ScrolledSliderDemo.es5.js.map
